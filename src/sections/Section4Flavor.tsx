...
export default function Section4Flavor() {
  ...
  return (
    <section ref={sectionRef} className="journey-section story-section relative w-full h-dvh overflow-hidden" style={{ zIndex: 40 }}>
      {/* Background */}
      <div className="section-bg absolute inset-0">
        <img src="/images/pink_stir_bg.jpg" alt="Stirring flavor base" loading="lazy" decoding="async" className="w-full h-full object-cover" />
      ...
      >
        <h2 className="font-display font-bold text-[#111] text-shadow-display leading-[0.95]">
          <span className="word block text-4xl md:text-5xl lg:text-6xl uppercase">Flavor</span>
          <span className="word block text-4xl md:text-5xl lg:text-6xl uppercase mt-1">Crafting</span>
        </h2>
